      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-end gap-2 pt-4">
          <Button
            ...
            className="rounded-full bg-[#615EEB] px-8 py-3 text-white transition-all hover:bg-[#5250d9] hover:shadow-md disabled:bg-gray-500 disabled:hover:bg-gray-500"
          >
            {isLoading ? (
          ...
          {!isLoggedIn && (
            <p className="text-sm text-gray-500">
              <button
                ...
                className="text-[#615EEB] underline font-medium hover:opacity-80"
              >
                Log in
              </button>
              {' '}required to generate policy issues
            </p>
          )}
        </div>
      </div>
