        ...
        <div className="mx-auto max-w-7xl px-4 py-4 lg:px-8">
          <div className="flex items-center justify-between">
            <Link
              ...
              className="text-2xl font-bold text-gray-900 transition-colors hover:text-[#615EEB]"
            >
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  {role === 'admin' && (
                    <Link
                      href="/admin"
                      className="rounded-lg border border-amber-300 bg-amber-50 px-4 py-2 text-base font-medium text-amber-700 transition-colors hover:border-amber-400 hover:bg-amber-100"
                    >
                      Admin
                    </Link>
                  )}
                  <Link
                    href="/my-page"
                    className="rounded-lg border border-gray-200 bg-white px-4 py-2 text-base font-medium text-gray-700 transition-colors hover:border-[#615EEB] hover:bg-[#615EEB]/5 hover:text-[#615EEB]"
                  >
                    My Page
                  </Link>
                  <Button
                ...
                <Button
                  ...
                  className="rounded-full bg-[#615EEB] px-5 py-2 text-base font-medium text-white transition-all hover:bg-[#5250d9] hover:shadow-md"
                >
                  Login
                </Button>
              )}
